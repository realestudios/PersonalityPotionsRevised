	...
	private static readonly string[] sentenceTemplates =
{
    ...
    "{playerName} {transitiveVerbs} my patience {adverb}.",
    ...
    "I’ll {transitiveVerbs} {playerName} for this {noun}.",
    ...
    "If I hear another {noun} from {playerName}, I'll {transitiveVerbs} them myself.",
